// package dev.pakn.competitioncubes.Archived;
...
// import dev.pakn.competitioncubes.DBController;
// import dev.pakn.competitioncubes.Match;
// import dev.pakn.competitioncubes.MatchController;
// import dev.pakn.competitioncubes.MatchFinder;
// import dev.pakn.competitioncubes.User;
...
//     ConcurrentHashMap<String, Integer> sessionUserIdMatchesMap = new ConcurrentHashMap<>();
...
//                     if (userMatch!=null) {
//                         sessionUserIdMatchesMap.put(headers.getSessionId(), userId);
...
//         int userId = sessionUserIdMatchesMap.get(event.getSessionId()) != null ? sessionUserIdMatchesMap.get(event.getSessionId()) : -1;
